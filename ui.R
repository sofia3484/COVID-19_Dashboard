...
# Written by : Sofia Nicklaus
# Department of Business statistics, Matana University (Tangerang)
# Notes: Please don't share this code anywhere
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
ui <- fluidPage(theme = shinytheme("journal"),
  ...
  navbarPage(title = div("COVID-19 Dashboard", style = "padding-left: 10px"),
    ...
    tabPanel("Table", icon = icon("table"), page_fullTable, value = "page-fullTable"),
    ...
    navbarMenu("More", icon = icon("question-circle"),
               tabPanel(tags$a("", href = "https://github.com/sofia3484/COVID-19_Dashboard", target = "_blank",list(icon("github"), "Resources"))),
               tabPanel(tags$a("", href = "https://www.linkedin.com/in/sofia-ns", target = "_blank",list(icon("linkedin"), "My Profile"))),
    ...
    header.append('<div style=\"float:right\"><a target=\"_blank\" href=\"https://www.youtube.com/watch?v=cNcLxXbFEEA\"><img src=\"Sofi.jpeg\" alt=\"alt\" style=\"float:right;width:33px;padding-top:10px;margin-top:-50px;margin-right:10px\"> </a></div>');
    console.log(header)")
    )
  )
)